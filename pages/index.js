      ...
      <main>
           <section className="flex flex-col justify-center items-center mt-10">
            ...
            <Image priority={true} src={pneu} height={450} width={600}/>
                        <div className="pt-2 text-center font-thin text-s">Catriona Jeffries, Slow Looking</div>
            ...
            <div className="pt-2 text-center font-thin text-s">Trepanier Baer, Standrds</div>
