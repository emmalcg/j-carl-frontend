...
export default function fontPage() {
  const [fontTest, setFontTest] = useState('Content is a font that was made in the year of [insert year]. Change the text here to try out Content. Click above to download the font and use for yourself.')
